...
# find passengers, banding the ages to four categories
combi$AgeCategory[combi$Age <= 4] <- "YoungChild"
combi$AgeCategory[combi$Age <= 16 & combi$Age > 4] <- "Child"
combi$AgeCategory[combi$Age <= 25 & combi$Age > 16] <- "YoungAdult"
combi$AgeCategory[combi$Age > 25] <- "Adult"
combi$AgeCategory[is.na(combi$Age)] <- "NA"
